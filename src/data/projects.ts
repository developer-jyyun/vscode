...
export const projects: Project[] = [
  ...
  },
  {
    id: "wedding-invite",
    title: "모바일 청첩장",
    desc: "React + TypeScript 기반으로 제작한 모바일 청첩장 SPA",
    ...
    children: [
      ...
      { title: "연락처 연결, 연락처 복사" },
      { title: "D-Day 카운트다운 & react-day-picker 캘린더" },
      { title: "카카오맵, 네이버 지도, 티맵 내비게이션 연동" },
      { title: "계좌번호 복사 및 카카오페이 송금 연동" },
      { title: "이미지 갤러리, 배경음악 토글, 영상 재생" },
    ],
    note: "실제 행사 초대용으로도 활용 가능한 반응형 SPA 프로젝트",
  },
  {
    id: "cotie-clone",
    title: "꼬띠샵 클론 코딩",
